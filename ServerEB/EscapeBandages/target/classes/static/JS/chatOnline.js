...
//////////////////////////////////TEXTO CHAT///////////////////////////////////////
	this.add.text(1200, 1030, 'Escribe aqui:', { font: '32px Arial', fill: '#ffffff' });
	
    textEntry = this.add.text(1450, 1030, '', { font: '32px Arial', fill: '#ffff00' });
    ...
    textArr = [];
    textArr[0] = this.add.text(1200, 950, '', { font: '32px Arial', fill: '#ff0000' });
	textArr[1] = this.add.text(1200, 900, '', { font: '32px Arial', fill: '#ff8000' });
	textArr[2] = this.add.text(1200, 850, '', { font: '32px Arial', fill: '#ffff00' });
	textArr[3] = this.add.text(1200, 800, '', { font: '32px Arial', fill: '#80ff00' });
	textArr[4] = this.add.text(1200, 750, '', { font: '32px Arial', fill: '#00ffff' });
	textArr[5] = this.add.text(1200, 700, '', { font: '32px Arial', fill: '#0080ff' });
	textArr[6] = this.add.text(1200, 650, '', { font: '32px Arial', fill: '#0000ff' });
	textArr[7] = this.add.text(1200, 600, '', { font: '32px Arial', fill: '#8000ff' });
	textArr[8] = this.add.text(1200, 550, '', { font: '32px Arial', fill: '#ff00ff' });
	textArr[9] = this.add.text(1200, 500, '', { font: '32px Arial', fill: '#ff0080' });
}
